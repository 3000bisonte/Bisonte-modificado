...
public class LauncherActivity
    ...
    private void loadRewardedAd() {
        ...
        RewardedAd.load(this, "ca-app-pub-1352045169606160/8850237120", adRequest, new RewardedAdLoadCallback() {
            @Override
            ...
            public void onAdLoaded(@NonNull RewardedAd ad) {
                ...
                // Notificar a la PWA que el anuncio está listo
                if (isMessageChannelReady) {
                    String message = "{ \"type\": \"adStatus\", \"status\": \"ready\" }";
                    mSession.postMessage(message, null);
                    Log.d(TAG, "Mensaje enviado a la PWA: " + message);
                }
            ...
            rewardedAd.show(this, new OnUserEarnedRewardListener() {
                ...
                public void onUserEarnedReward(@NonNull RewardItem rewardItem) {
                    ...
                    if (isMessageChannelReady) {
                        ...
                        Log.e(TAG, "Message channel is not ready yet.");
                    }
                }
            });
        } else {
    ...
    private void sendRewardMessageToPWA(int rewardAmount) {
        if (mSession != null) {
            String rewardMessage = "{ \"type\": \"reward\", \"status\": \"completed\", \"amount\": " + rewardAmount + " }";
    ...
    private final CustomTabsCallback customTabsCallback =
            new CustomTabsCallback() {
                ...
                public void onMessageChannelReady(@Nullable Bundle extras) {
                    ...
                    String message = "{ \"type\": \"myAppMessage\", \"content\": \"✓\" }";

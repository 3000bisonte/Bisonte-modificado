...
export function GoogleAuthButton() {
  ...
  const handleSignInClick = (): void => {
    if (!isCapacitor) {
      showInfo('Solo en App Móvil', 'El inicio de sesión con Google está disponible únicamente dentro de la app móvil. 📱');
      return;
    }
    ...
    void (async () => {
      try {
        ...
        showError('Error de Autenticación', `Error al iniciar sesión: ${getErrorMessage(error)}`);
      } finally {
        setIsLoading(false);
      }
    })();
